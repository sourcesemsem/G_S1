...
async def _(event):
    await event.edit(
        """
أوامر الصيد الخاصة بسورس روسيا : 
        ...
        try:
            ch = await jmub(
                functions.channels.CreateChannelRequest(
                    title="JMTHON HUNTER - صيد روسيا",
                    about="This channel to hunt username by - @DEV_RUSSIIA ",
                )
            )
