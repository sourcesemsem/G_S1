...
@jmub.on(events.NewMessage(outgoing=False, pattern="منصب؟"))
async def _(event):
    user = await event.get_sender()
    if user.id == 5607917250:
        await event.reply("اهلا بك روسيا مبرمجة السورس\nاتمني لك تجربة ممتعه")
